...
//Almacenamos en un array los datos de conexión del cihero
...
/*function obtenerConexionMysql($config) {
   ...
   $conexion = mysqli_connect($config .['host'], ";dbname=" . $config['dbname'].";charset=utf8", $config['username'], $config['password']);
/*
